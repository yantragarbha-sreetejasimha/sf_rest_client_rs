...
pub struct StatefulServicePartitionInfo {
    ...
    #[serde(rename = "CurrentConfigurationEpoch")]
    current_configuration_epoch: Option<::models::Epoch>,
}
...
impl StatefulServicePartitionInfo {
    ...
    pub fn new(
        ...
        StatefulServicePartitionInfo {
            ...
            current_configuration_epoch: None,
        }
    }
    ...
    pub fn set_current_configuration_epoch(
        &mut self,
        current_configuration_epoch: ::models::Epoch,
    ) {
        self.current_configuration_epoch = Some(current_configuration_epoch);
    }

    pub fn with_current_configuration_epoch(
        mut self,
        current_configuration_epoch: ::models::Epoch,
    ) -> StatefulServicePartitionInfo {
        self.current_configuration_epoch = Some(current_configuration_epoch);
    ...
    pub fn current_configuration_epoch(&self) -> Option<&::models::Epoch> {
        self.current_configuration_epoch.as_ref()
    }

    pub fn reset_current_configuration_epoch(&mut self) {
        self.current_configuration_epoch = None;
    }
}
