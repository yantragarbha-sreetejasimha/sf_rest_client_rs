...
pub struct NodeInfo {
    ...
    #[serde(rename = "IsNodeByNodeUpgradeInProgress")]
    is_node_by_node_upgrade_in_progress: Option<bool>,
    /// PlacementID used by the InfrastructureService.
    #[serde(rename = "InfrastructurePlacementID")]
    infrastructure_placement_id: Option<String>,
}
...
impl NodeInfo {
    ...
    pub fn new() -> NodeInfo {
        NodeInfo {
            ...
            node_down_at: None,
            node_tags: None,
            is_node_by_node_upgrade_in_progress: None,
            infrastructure_placement_id: None,
        }
    }
    ...
    pub fn set_is_node_by_node_upgrade_in_progress(
        &mut self,
        is_node_by_node_upgrade_in_progress: bool,
    ) {
        self.is_node_by_node_upgrade_in_progress =
            Some(is_node_by_node_upgrade_in_progress);
    }

    pub fn with_is_node_by_node_upgrade_in_progress(
        mut self,
        is_node_by_node_upgrade_in_progress: bool,
    ) -> NodeInfo {
        self.is_node_by_node_upgrade_in_progress =
    ...
    pub fn is_node_by_node_upgrade_in_progress(&self) -> Option<&bool> {
        self.is_node_by_node_upgrade_in_progress.as_ref()
    }

    pub fn reset_is_node_by_node_upgrade_in_progress(&mut self) {
        self.is_node_by_node_upgrade_in_progress = None;
    }

    pub fn set_infrastructure_placement_id(
        &mut self,
        infrastructure_placement_id: String,
    ) {
        self.infrastructure_placement_id = Some(infrastructure_placement_id);
    }

    pub fn with_infrastructure_placement_id(
        mut self,
        infrastructure_placement_id: String,
    ) -> NodeInfo {
        self.infrastructure_placement_id = Some(infrastructure_placement_id);
    ...
    pub fn infrastructure_placement_id(&self) -> Option<&String> {
        self.infrastructure_placement_id.as_ref()
    }

    pub fn reset_infrastructure_placement_id(&mut self) {
        self.infrastructure_placement_id = None;
    }
}
