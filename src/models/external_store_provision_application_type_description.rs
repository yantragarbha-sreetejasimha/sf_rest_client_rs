...
pub struct ExternalStoreProvisionApplicationTypeDescription {
    ...
    application_package_download_uri: Option<String>,
    ...
    application_type_name: Option<String>,
    ...
    application_type_version: Option<String>,
}
...
impl ExternalStoreProvisionApplicationTypeDescription {
    ...
    pub fn set_application_package_download_uri(
        ...
        self.application_package_download_uri =
            Some(application_package_download_uri);
    }
    ...
    pub fn application_package_download_uri(&self) -> Option<&String> {
        self.application_package_download_uri.as_ref()
    }

    pub fn reset_application_package_download_uri(&mut self) {
        self.application_package_download_uri = None;
    }
    ...
    pub fn application_type_name(&self) -> Option<&String> {
    ...
    pub fn set_application_type_version(
        ...
        self.application_type_version = Some(application_type_version);
    }
    ...
    pub fn application_type_version(&self) -> Option<&String> {
        self.application_type_version.as_ref()
    }

    pub fn reset_application_type_version(&mut self) {
        self.application_type_version = None;
    }
}
