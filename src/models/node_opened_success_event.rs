...
pub struct NodeOpenedSuccessEvent {
...
impl NodeOpenedSuccessEvent {
    ...
    pub fn with_node_id(mut self, node_id: String) -> NodeOpenedSuccessEvent {
        self.node_id = node_id;
        self
    }
    ...
    pub fn with_hostname(mut self, hostname: String) -> NodeOpenedSuccessEvent {
        self.hostname = hostname;
        self
    }
