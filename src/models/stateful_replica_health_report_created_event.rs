...
pub struct StatefulReplicaHealthReportCreatedEvent {
...
impl StatefulReplicaHealthReportCreatedEvent {
    ...
    pub fn set_replica_instance_id(&mut self, replica_instance_id: i64) {
        self.replica_instance_id = replica_instance_id;
    }

    pub fn with_replica_instance_id(
        mut self,
        replica_instance_id: i64,
    ) -> StatefulReplicaHealthReportCreatedEvent {
        self.replica_instance_id = replica_instance_id;
    ...
    pub fn replica_instance_id(&self) -> &i64 {
