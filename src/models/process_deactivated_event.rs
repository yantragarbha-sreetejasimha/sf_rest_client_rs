...
pub struct ProcessDeactivatedEvent {
...
impl ProcessDeactivatedEvent {
    ...
    pub fn with_host_id(mut self, host_id: String) -> ProcessDeactivatedEvent {
        self.host_id = host_id;
        self
    }
    ...
    pub fn with_exit_code(mut self, exit_code: i64) -> ProcessDeactivatedEvent {
        self.exit_code = exit_code;
        self
    }
