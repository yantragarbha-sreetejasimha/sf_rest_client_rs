...
pub struct NodeUpgradeProgressInfo {
    ...
    upgrade_duration: Option<::models::NodeUpgradeDurationString>,
}
...
impl NodeUpgradeProgressInfo {
    ...
    pub fn set_upgrade_duration(
        &mut self,
        upgrade_duration: ::models::NodeUpgradeDurationString,
    ) {
    ...
    pub fn upgrade_duration(
        &self,
    ) -> Option<&::models::NodeUpgradeDurationString> {
