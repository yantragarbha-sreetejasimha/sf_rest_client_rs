...
/// PagedServiceResourceDescriptionList : The list of service resources in the cluster. The list is paged when all of the results cannot fit in a single message. The next set of results can be obtained by executing the same query with the continuation token provided in this list.
...
pub struct PagedServiceResourceDescriptionList {
    ...
    #[serde(rename = "Items")]
    items: Option<Vec<::models::ServiceResourceDescription>>,
}

impl Default for PagedServiceResourceDescriptionList {
    fn default() -> Self {
        Self::new()
    }
}
...
impl PagedServiceResourceDescriptionList {
    ...
    pub fn new() -> PagedServiceResourceDescriptionList {
    ...
    pub fn set_items(
        &mut self,
        items: Vec<::models::ServiceResourceDescription>,
    ) {
    ...
    pub fn items(&self) -> Option<&Vec<::models::ServiceResourceDescription>> {
        self.items.as_ref()
    }
