...
pub struct PartitionLoadInformation {
    ...
    #[serde(rename = "AuxiliaryLoadMetricReports")]
    auxiliary_load_metric_reports: Option<Vec<::models::LoadMetricReport>>,
}
...
impl PartitionLoadInformation {
    ...
    pub fn set_auxiliary_load_metric_reports(
        &mut self,
        auxiliary_load_metric_reports: Vec<::models::LoadMetricReport>,
    ) {
        self.auxiliary_load_metric_reports =
            Some(auxiliary_load_metric_reports);
    }

    pub fn with_auxiliary_load_metric_reports(
        mut self,
        auxiliary_load_metric_reports: Vec<::models::LoadMetricReport>,
    ) -> PartitionLoadInformation {
        self.auxiliary_load_metric_reports =
    ...
    pub fn auxiliary_load_metric_reports(
        &self,
    ) -> Option<&Vec<::models::LoadMetricReport>> {
        self.auxiliary_load_metric_reports.as_ref()
    }

    pub fn reset_auxiliary_load_metric_reports(&mut self) {
        self.auxiliary_load_metric_reports = None;
    }
}
