...
pub struct RestoreProgressInfo {
    ...
    restored_epoch: Option<::models::Epoch>,
    /// Restored LSN.
...
impl RestoreProgressInfo {
    ...
    pub fn set_restored_epoch(&mut self, restored_epoch: ::models::Epoch) {
        self.restored_epoch = Some(restored_epoch);
    }

    pub fn with_restored_epoch(
        mut self,
        restored_epoch: ::models::Epoch,
    ) -> RestoreProgressInfo {
        self.restored_epoch = Some(restored_epoch);
        self
    }

    pub fn restored_epoch(&self) -> Option<&::models::Epoch> {
