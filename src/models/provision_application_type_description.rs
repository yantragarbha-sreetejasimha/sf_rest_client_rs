...
pub struct ProvisionApplicationTypeDescription {
    ...
    application_type_build_path: Option<String>,
...
impl ProvisionApplicationTypeDescription {
    ...
    pub fn set_application_type_build_path(
        ...
        self.application_type_build_path = Some(application_type_build_path);
    }
    ...
    pub fn application_type_build_path(&self) -> Option<&String> {
        self.application_type_build_path.as_ref()
    }

    pub fn reset_application_type_build_path(&mut self) {
        self.application_type_build_path = None;
    }
