...
pub struct DeployedServiceHealthReportExpiredEvent {
...
impl DeployedServiceHealthReportExpiredEvent {
    ...
    pub fn set_ttl_timespan(&mut self, ttl_timespan: i64) {
        self.ttl_timespan = ttl_timespan;
    }

    pub fn with_ttl_timespan(
        mut self,
        ttl_timespan: i64,
    ) -> DeployedServiceHealthReportExpiredEvent {
        self.ttl_timespan = ttl_timespan;
