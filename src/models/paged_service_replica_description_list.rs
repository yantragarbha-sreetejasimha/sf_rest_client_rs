...
pub struct PagedServiceReplicaDescriptionList {
    ...
    #[serde(rename = "Items")]
    items: Option<Vec<::models::ServiceReplicaDescription>>,
}

impl Default for PagedServiceReplicaDescriptionList {
    fn default() -> Self {
        Self::new()
    }
}
...
impl PagedServiceReplicaDescriptionList {
    ...
    pub fn new() -> PagedServiceReplicaDescriptionList {
    ...
    pub fn set_items(
        &mut self,
        items: Vec<::models::ServiceReplicaDescription>,
    ) {
    ...
    pub fn items(&self) -> Option<&Vec<::models::ServiceReplicaDescription>> {
        self.items.as_ref()
    }
