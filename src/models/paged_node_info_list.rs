...
pub struct PagedNodeInfoList {
    ...
    #[serde(rename = "Items")]
    items: Option<Vec<::models::NodeInfo>>,
}

impl Default for PagedNodeInfoList {
    fn default() -> Self {
        Self::new()
    }
}
...
impl PagedNodeInfoList {
    ...
    pub fn set_items(&mut self, items: Vec<::models::NodeInfo>) {
        self.items = Some(items);
    }

    pub fn with_items(
        mut self,
        items: Vec<::models::NodeInfo>,
    ) -> PagedNodeInfoList {
        self.items = Some(items);
        self
    }

    pub fn items(&self) -> Option<&Vec<::models::NodeInfo>> {
        self.items.as_ref()
    }
