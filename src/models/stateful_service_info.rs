...
pub struct StatefulServiceInfo {
    ...
    has_persisted_state: Option<bool>,
}

impl StatefulServiceInfo {
    /// Information about a stateful Service Fabric service.
    pub fn new(service_kind: ::models::ServiceKind) -> StatefulServiceInfo {
        StatefulServiceInfo {
            id: None,
            service_kind,
            name: None,
    ...
    pub fn with_id(mut self, id: ::models::ServiceId) -> StatefulServiceInfo {
        self.id = Some(id);
        self
    }
    ...
    pub fn set_has_persisted_state(&mut self, has_persisted_state: bool) {
        self.has_persisted_state = Some(has_persisted_state);
    }
    ...
    pub fn has_persisted_state(&self) -> Option<&bool> {
        self.has_persisted_state.as_ref()
    }

    pub fn reset_has_persisted_state(&mut self) {
