...
pub struct PagedServicePartitionInfoList {
    ...
    #[serde(rename = "Items")]
    items: Option<Vec<::models::ServicePartitionInfo>>,
}

impl Default for PagedServicePartitionInfoList {
    fn default() -> Self {
        Self::new()
    }
}
...
impl PagedServicePartitionInfoList {
    ...
    pub fn new() -> PagedServicePartitionInfoList {
    ...
    pub fn set_items(&mut self, items: Vec<::models::ServicePartitionInfo>) {
        self.items = Some(items);
    }

    pub fn with_items(
        mut self,
        items: Vec<::models::ServicePartitionInfo>,
    ) -> PagedServicePartitionInfoList {
        self.items = Some(items);
        self
    }

    pub fn items(&self) -> Option<&Vec<::models::ServicePartitionInfo>> {
        self.items.as_ref()
    }
