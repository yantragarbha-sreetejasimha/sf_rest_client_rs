...
impl NodeOpeningEvent {
    ...
    pub fn with_time_stamp(mut self, time_stamp: String) -> NodeOpeningEvent {
        self.time_stamp = time_stamp;
        self
    }
    ...
    pub fn with_node_id(mut self, node_id: String) -> NodeOpeningEvent {
        self.node_id = node_id;
        self
    }
    ...
    pub fn with_hostname(mut self, hostname: String) -> NodeOpeningEvent {
        self.hostname = hostname;
        self
    }
    ...
    pub fn with_is_seed_node(mut self, is_seed_node: bool) -> NodeOpeningEvent {
        self.is_seed_node = is_seed_node;
        self
    }
