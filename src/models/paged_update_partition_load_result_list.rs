...
pub struct PagedUpdatePartitionLoadResultList {
    ...
    #[serde(rename = "Items")]
    items: Option<Vec<::models::UpdatePartitionLoadResult>>,
}

impl Default for PagedUpdatePartitionLoadResultList {
    fn default() -> Self {
        Self::new()
    }
}
...
impl PagedUpdatePartitionLoadResultList {
    ...
    pub fn new() -> PagedUpdatePartitionLoadResultList {
    ...
    pub fn set_items(
        &mut self,
        items: Vec<::models::UpdatePartitionLoadResult>,
    ) {
    ...
    pub fn items(&self) -> Option<&Vec<::models::UpdatePartitionLoadResult>> {
        self.items.as_ref()
    }
