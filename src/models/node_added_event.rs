...
impl NodeAddedEvent {
    ...
    pub fn with_time_stamp(mut self, time_stamp: String) -> NodeAddedEvent {
        self.time_stamp = time_stamp;
        self
    }
    ...
    pub fn with_node_id(mut self, node_id: String) -> NodeAddedEvent {
        self.node_id = node_id;
        self
    }
    ...
    pub fn with_node_instance(mut self, node_instance: i64) -> NodeAddedEvent {
        self.node_instance = node_instance;
        self
    }
    ...
    pub fn with_node_type(mut self, node_type: String) -> NodeAddedEvent {
        self.node_type = node_type;
        self
    }
