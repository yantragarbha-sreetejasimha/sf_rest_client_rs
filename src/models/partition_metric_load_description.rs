...
impl PartitionMetricLoadDescription {
    ...
    pub fn set_auxiliary_replicas_load_entries(
        &mut self,
        auxiliary_replicas_load_entries: Vec<::models::MetricLoadDescription>,
    ) {
        self.auxiliary_replicas_load_entries =
            Some(auxiliary_replicas_load_entries);
    }

    pub fn with_auxiliary_replicas_load_entries(
        mut self,
        auxiliary_replicas_load_entries: Vec<::models::MetricLoadDescription>,
    ) -> PartitionMetricLoadDescription {
        self.auxiliary_replicas_load_entries =
    ...
    pub fn auxiliary_replicas_load_entries(
        &self,
    ) -> Option<&Vec<::models::MetricLoadDescription>> {
        self.auxiliary_replicas_load_entries.as_ref()
    }

    pub fn reset_auxiliary_replicas_load_entries(&mut self) {
        self.auxiliary_replicas_load_entries = None;
    }

    pub fn set_auxiliary_replica_load_entries_per_node(
        &mut self,
        auxiliary_replica_load_entries_per_node: Vec<
            ::models::ReplicaMetricLoadDescription,
        >,
    ) {
        self.auxiliary_replica_load_entries_per_node =
            Some(auxiliary_replica_load_entries_per_node);
    }

    pub fn with_auxiliary_replica_load_entries_per_node(
        mut self,
        auxiliary_replica_load_entries_per_node: Vec<
            ::models::ReplicaMetricLoadDescription,
        >,
    ...
    pub fn auxiliary_replica_load_entries_per_node(
        &self,
    ) -> Option<&Vec<::models::ReplicaMetricLoadDescription>> {
        self.auxiliary_replica_load_entries_per_node.as_ref()
    }

    pub fn reset_auxiliary_replica_load_entries_per_node(&mut self) {
        self.auxiliary_replica_load_entries_per_node = None;
    }
}
