...
pub struct ChaosStartedEvent {
    ...
    #[serde(rename = "WaitTimeBetweenFautlsInSeconds")]
    wait_time_between_fautls_in_seconds: f64,
...
impl ChaosStartedEvent {
    ...
    pub fn set_wait_time_between_fautls_in_seconds(
        &mut self,
        wait_time_between_fautls_in_seconds: f64,
    ) {
        self.wait_time_between_fautls_in_seconds =
            wait_time_between_fautls_in_seconds;
    }

    pub fn with_wait_time_between_fautls_in_seconds(
        mut self,
        wait_time_between_fautls_in_seconds: f64,
    ) -> ChaosStartedEvent {
        self.wait_time_between_fautls_in_seconds =
    ...
    pub fn wait_time_between_fautls_in_seconds(&self) -> &f64 {
        &self.wait_time_between_fautls_in_seconds
    }
