...
pub struct HealthEvent {
    ...
    #[serde(rename = "HealthReportId")]
    health_report_id: Option<String>,
...
impl HealthEvent {
    ...
    pub fn set_health_report_id(&mut self, health_report_id: String) {
        self.health_report_id = Some(health_report_id);
    }

    pub fn with_health_report_id(
        mut self,
    ...
    pub fn health_report_id(&self) -> Option<&String> {
        self.health_report_id.as_ref()
    }

    pub fn reset_health_report_id(&mut self) {
        self.health_report_id = None;
    }
