...
pub struct PagedApplicationResourceDescriptionList {
    ...
    #[serde(rename = "Items")]
    items: Option<Vec<::models::ApplicationResourceDescription>>,
}

impl Default for PagedApplicationResourceDescriptionList {
    fn default() -> Self {
        Self::new()
    }
}
...
impl PagedApplicationResourceDescriptionList {
    ...
    pub fn new() -> PagedApplicationResourceDescriptionList {
    ...
    pub fn set_items(
        &mut self,
        items: Vec<::models::ApplicationResourceDescription>,
    ) {
    ...
    pub fn items(
        &self,
    ) -> Option<&Vec<::models::ApplicationResourceDescription>> {
        self.items.as_ref()
    }
