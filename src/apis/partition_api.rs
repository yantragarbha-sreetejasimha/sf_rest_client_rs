...
pub trait PartitionApi {
    fn get_loaded_partition_info_list(
        &self,
        api_version: &str,
        metric_name: &str,
        service_name: &str,
        ...
        dyn Future<
            Item = ::models::LoadedPartitionInformationResultList,
...
impl<C: hyper::client::Connect> PartitionApi for PartitionApiClient<C> {
    ...
    > {
        ...
        let query_string = {
            ...
            query.append_pair("MetricName", metric_name);
            query.append_pair("ServiceName", service_name);
            query.append_pair("Ordering", ordering);
        ...
        Box::new(
            configuration
                ...
                .and_then(|body| {
                    let parsed: Result<
                        ::models::LoadedPartitionInformationResultList,
                        _,
    ...
    fn move_auxiliary_replica(
        ...
        let uri_str = format!("{}/Services/{serviceId}/$/GetPartitions/{partitionId}/$/MoveAuxiliaryReplica?{}", configuration.base_path, query_string, serviceId=service_id, partitionId=partition_id);
    ...
    fn move_instance(
        ...
        let uri_str = format!("{}/Services/{serviceId}/$/GetPartitions/{partitionId}/$/MoveInstance?{}", configuration.base_path, query_string, serviceId=service_id, partitionId=partition_id);
