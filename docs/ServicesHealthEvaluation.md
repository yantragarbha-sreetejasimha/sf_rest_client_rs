...
**service_type_name** | **String** | Name of the service type of the services. | [optional] [default to null]
**max_percent_unhealthy_services** | **i32** | Maximum allowed percentage of unhealthy services from the ServiceTypeHealthPolicy. | [optional] [default to null]
**total_count** | **i64** | Total number of services of the current service type in the application from the health store. | [optional] [default to null]
**unhealthy_evaluations** | [***::models::UnhealthyEvaluations**](UnhealthyEvaluations.md) | List of unhealthy evaluations that led to the aggregated health state. Includes all the unhealthy ServiceHealthEvaluation that impacted the aggregated health. | [optional] [default to null]
