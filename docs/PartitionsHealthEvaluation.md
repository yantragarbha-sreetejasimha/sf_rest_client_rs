...
**max_percent_unhealthy_partitions_per_service** | **i32** | Maximum allowed percentage of unhealthy partitions per service from the ServiceTypeHealthPolicy. | [optional] [default to null]
**total_count** | **i64** | Total number of partitions of the service from the health store. | [optional] [default to null]
**unhealthy_evaluations** | [***::models::UnhealthyEvaluations**](UnhealthyEvaluations.md) | List of unhealthy evaluations that led to the aggregated health state. Includes all the unhealthy PartitionHealthEvaluation that impacted the aggregated health. | [optional] [default to null]
