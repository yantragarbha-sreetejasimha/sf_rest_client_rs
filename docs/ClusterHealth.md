...
**node_health_states** | [**Vec<::models::NodeHealthState>**](NodeHealthState.md) | Cluster node health states as found in the health store. | [optional] [default to null]
**application_health_states** | [**Vec<::models::ApplicationHealthState>**](ApplicationHealthState.md) | Cluster application health states as found in the health store. | [optional] [default to null]
