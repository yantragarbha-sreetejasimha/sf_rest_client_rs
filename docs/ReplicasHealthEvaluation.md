...
**max_percent_unhealthy_replicas_per_partition** | **i32** | Maximum allowed percentage of unhealthy replicas per partition from the ApplicationHealthPolicy. | [optional] [default to null]
**total_count** | **i64** | Total number of replicas in the partition from the health store. | [optional] [default to null]
**unhealthy_evaluations** | [***::models::UnhealthyEvaluations**](UnhealthyEvaluations.md) | List of unhealthy evaluations that led to the aggregated health state. Includes all the unhealthy ReplicaHealthEvaluation that impacted the aggregated health. | [optional] [default to null]
