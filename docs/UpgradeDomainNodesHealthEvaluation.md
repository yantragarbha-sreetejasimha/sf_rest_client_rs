...
**max_percent_unhealthy_nodes** | **i32** | Maximum allowed percentage of unhealthy nodes from the ClusterHealthPolicy. | [optional] [default to null]
**total_count** | **i64** | Total number of nodes in the current upgrade domain. | [optional] [default to null]
