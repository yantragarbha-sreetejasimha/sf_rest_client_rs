...
**failure_reason** | **String** | Describes reason of failure. | [default to null]
**overall_upgrade_elapsed_time_in_ms** | **f64** | Overall upgrade time in milli-seconds. | [default to null]
