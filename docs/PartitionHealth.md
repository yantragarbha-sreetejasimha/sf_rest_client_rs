...
**partition_id** | [***::models::PartitionId**](PartitionId.md) | ID of the partition whose health information is described by this object. | [optional] [default to null]
**replica_health_states** | [**Vec<::models::ReplicaHealthState>**](ReplicaHealthState.md) | The list of replica health states associated with the partition. | [optional] [default to null]
