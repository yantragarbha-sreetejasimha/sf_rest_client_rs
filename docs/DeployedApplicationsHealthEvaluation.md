...
**max_percent_unhealthy_deployed_applications** | **i32** | Maximum allowed percentage of unhealthy deployed applications from the ApplicationHealthPolicy. | [optional] [default to null]
**total_count** | **i64** | Total number of deployed applications of the application in the health store. | [optional] [default to null]
