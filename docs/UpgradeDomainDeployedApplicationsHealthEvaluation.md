...
**upgrade_domain_name** | **String** | Name of the upgrade domain where deployed applications health is currently evaluated. | [optional] [default to null]
**max_percent_unhealthy_deployed_applications** | **i32** | Maximum allowed percentage of unhealthy deployed applications from the ClusterHealthPolicy. | [optional] [default to null]
**total_count** | **i64** | Total number of deployed applications in the current upgrade domain. | [optional] [default to null]
**unhealthy_evaluations** | [***::models::UnhealthyEvaluations**](UnhealthyEvaluations.md) | List of unhealthy evaluations that led to the aggregated health state. Includes all the unhealthy DeployedApplicationHealthEvaluation that impacted the aggregated health. | [optional] [default to null]
