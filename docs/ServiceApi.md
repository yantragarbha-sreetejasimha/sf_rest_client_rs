...
> ::models::UnplacedReplicaInformation get_unplaced_replica_information(api_version, service_id, optional)
 ...
 **only_query_primaries** | **bool**| Indicates that unplaced replica information will be queries only for primary replicas. | [default to false]
 **timeout** | **i64**| The server timeout for performing the operation in seconds. This timeout specifies the time duration that the client is willing to wait for the requested operation to complete. The default value for this parameter is 60 seconds. | [default to 60]

### Return type

[**::models::UnplacedReplicaInformation**](UnplacedReplicaInformation.md)
...
# **update_service**
> update_service(api_version, service_id, service_update_description, optional)
