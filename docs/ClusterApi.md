...
[**validate_cluster_upgrade**](ClusterApi.md#validate_cluster_upgrade) | **Post** /$/ValidateUpgrade | Validate and assess the impact of a code or configuration version update of a Service Fabric cluster.
...
[**::models::ClusterConfiguration**](ClusterConfiguration.md)
...
> start_cluster_configuration_upgrade(api_version, cluster_configuration_upgrade_description, optional)
...
> start_cluster_upgrade(api_version, start_cluster_upgrade_description, optional)
...
# **unprovision_cluster**
> unprovision_cluster(api_version, unprovision_fabric_description, optional)
...
> update_cluster_upgrade(api_version, update_cluster_upgrade_description, optional)
...
> ::models::ValidateClusterUpgradeResult validate_cluster_upgrade(api_version, start_cluster_upgrade_description, optional)
...
[**::models::ValidateClusterUpgradeResult**](ValidateClusterUpgradeResult.md)
