...
> report_replica_health(api_version, partition_id, replica_id, replica_health_report_service_kind, health_information, optional)
...
------------- | ------------- | ------------- | -------------
  ...
  **partition_id** | [**String**](.md)| The identity of the partition. | 
  **replica_id** | **String**| The identifier of the replica. | 
  **replica_health_report_service_kind** | **String**| The kind of service replica (Stateless or Stateful) for which the health is being reported. Following are the possible values. | [default to Stateful]
